...
.page::before {
  ...
  background-repeat: no-repeat; background-position: center 52%;
  background-size: 62% auto; opacity: 0.18;
...
.logo { width: 26mm; height: 26mm; object-fit: contain; mix-blend-mode: multiply; }
...
.cert-id { font-family: 'Courier New', monospace; font-size: 10pt; color: #555; letter-spacing: 1px; }
